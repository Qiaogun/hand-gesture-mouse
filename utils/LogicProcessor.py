...
class LogicProcessor(object):
    ...
    def noti_emit(self, str):
        self.object.print_signal.emit(str)
                ...
                if results.multi_hand_landmarks is not None:
                    for hand_landmarks, handedness in zip(
                        ...
                        for i, landmark_point in enumerate(landmark_list):
                            if i == (0 or 5 or 9 or 17):
                                list_x.append(landmark_point[0])
                                list_y.append(landmark_point[1])
                        mean_x_point = np.mean(list_x)
                        mean_y_point = np.mean(list_y)
                        #print(mean_x_point,mean_y_point)
                        # 相対座標・正規化座標への変換
                        ...
                        HM.check_hand_state(
                            ...
                            point_history_classifier_labels[most_common_fg_id[0]
                                                            [0]],
                            mean_x_point=mean_x_point,
                            mean_y_point=mean_y_point)
                        # 描画
...
def xy_landmark_list(image, landmarks):
